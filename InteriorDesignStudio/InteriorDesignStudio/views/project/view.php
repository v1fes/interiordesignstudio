...
<div class="container mt-4">
    <?php if (!empty($project['PhotoPath'])): ?>
        <div class="row mb-4">
            <div class="col-12">
                <img src="/InteriorDesignStudio/files/projects/<?= htmlspecialchars($project['PhotoPath']) ?>" alt="Фото проекту" class="img-fluid project-photo" style="width: 100%; cursor: pointer;">
            </div>
        </div>
    <?php endif; ?>
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="text-center mb-4">
                <?php if ($user && $user->isAdmin()): ?>
                    <a href="http://localhost/InteriorDesignStudio/project/edit/<?= $project['ProjectID'] ?>" class="btn btn-primary">Редагувати</a>
                    <a href="http://localhost/InteriorDesignStudio/project/delete/<?= $project['ProjectID'] ?>" class="btn btn-danger">Видалити</a>
                <?php endif; ?>
                <a href="http://localhost/InteriorDesignStudio/project/list" class="btn btn-secondary">Повернутись до списку</a>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <a href="http://localhost/InteriorDesignStudio/projectcomment/add/<?= $project['ProjectID'] ?>" class="btn btn-primary mt-3">Додати коментар</a>
                </div>
            </div>
        </div>
    </div>
