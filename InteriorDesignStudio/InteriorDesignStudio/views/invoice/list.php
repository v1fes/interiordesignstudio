    ...
    <tbody>
        <?php foreach ($invoices as $invoice): ?>
            <tr>
                ...
                <td>
                    <a href="http://localhost/InteriorDesignStudio/invoice/edit/<?= $invoice['InvoiceID'] ?>" class="btn btn-warning">Редагувати</a>
...
<a href="http://localhost/InteriorDesignStudio/invoices/create" class="btn btn-primary">Створити новий інвойс</a>
