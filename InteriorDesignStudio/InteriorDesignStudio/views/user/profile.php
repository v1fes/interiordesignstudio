...
<main class="container mt-4">
                    ...
                    <?php foreach ($projects as $project): ?>
                        <div class="col-md-4 project-card">
                            <div class="card h-100">
                                <div class="card-body">
                                    <a href="http://localhost/InteriorDesignStudio/project/view/<?= htmlspecialchars($project['ProjectID']) ?>">
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="http://localhost/InteriorDesignStudio/user/update" class="btn btn-primary">Edit Profile</a>
            <a href="http://localhost/InteriorDesignStudio/user/logout" class="btn btn-danger">Logout</a>
        </div>
    </main>
